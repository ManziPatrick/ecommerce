...
function formatAnalyticsData(data) {
    if (Array.isArray(data)) {
        ...
        const overviewData = (0, flattenObject_1.default)({
            ...overview,
        ...
        const productsData = products.map((item, index) => ({
            productRank: index + 1,
            ...(0, flattenObject_1.default)(item),
        }));
        const usersData = [
            ...
            ...users.topUsers.map((user, index) => ({
                topUserRank: index + 1,
                ...(0, flattenObject_1.default)(user),
            })),
        ];
        ...
        // UserAnalytics
        const { topUsers, interactionTrends, changes, ...rest } = data;
        const flattenedRest = (0, flattenObject_1.default)({
            ...rest,
            changes,
            interactionTrends: {
        ...
        // AnalyticsOverview
        const { monthlyTrends, changes, ...rest } = data;
        const flattenedRest = (0, flattenObject_1.default)({
            ...rest,
            changes,
            monthlyTrends: {
        ...
        const salesData = (0, flattenObject_1.default)({
            ...sales,
            byCategory: JSON.stringify(sales.byCategory),
            topProducts: JSON.stringify(sales.topProducts),
        });
        const userRetentionData = (0, flattenObject_1.default)({
            ...userRetention,
        ...
        // SalesReport
        const { byCategory, topProducts, ...rest } = data;
        const flattenedRest = (0, flattenObject_1.default)({
            ...rest,
