    ...
    if (startDate && endDate) {
        ...
        switch (timePeriod) {
            ...
            case "lastYear":
                ...
                break;
            case "thisMonth":
                // Current period: start of this month.
                currentStartDate = new Date(now.getFullYear(), now.getMonth(), 1);
                previousStartDate = (0, date_fns_1.subMonths)(currentStartDate, 1);
                previousEndDate = currentStartDate;
                break;
            case "thisYear":
                // Current period: start of this year.
                currentStartDate = new Date(now.getFullYear(), 0, 1);
                previousStartDate = (0, date_fns_1.subYears)(currentStartDate, 1);
                previousEndDate = currentStartDate;
                break;
            case "allTime":
