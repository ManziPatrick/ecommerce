...
const discount_routes_1 = __importDefault(require("@/modules/discount/discount.routes"));
...
const vendorRequest_routes_1 = __importDefault(require("@/modules/vendorRequest/vendorRequest.routes"));
const configureV1Routes = (io) => {
    ...
    router.use('/vendor-requests', vendorRequest_routes_1.default);
    return router;
};
