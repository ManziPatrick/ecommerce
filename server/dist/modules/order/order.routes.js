 ...
 */
router.get("/", protect_1.default, (0, authorizeRole_1.default)("ADMIN", "SUPERADMIN", "VENDOR"), orderController.getAllOrders);
/**
 * @swagger
 * /orders/user:
 *   get:
 ...
 *         description: Unauthorized. Token is invalid or missing.
 */
router.post("/", protect_1.default, orderController.createOrder);
/**
 * @swagger
 * /orders/{orderId}:
 *   put:
 ...
 *         description: Order not found.
 */
router.put("/:orderId", protect_1.default, (0, authorizeRole_1.default)("ADMIN", "SUPERADMIN", "VENDOR"), orderController.updateOrder);
/**
 * @swagger
 ...
 */
router.post("/:orderId/return", protect_1.default, orderController.requestReturn);
