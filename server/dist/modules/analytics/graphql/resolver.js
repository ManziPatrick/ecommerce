...
exports.analyticsResolvers = {
    Query: {
        ...orderAnalytics_1.default.Query,
        ...revenueAnalytics_1.default.Query,
        ...userAnalytics_2.default.Query,
        ...yearRange_1.default.Query,
        ...userAnalytics_1.default.Query,
        ...interactionAnalytics_1.default.Query,
        ...productPerformance_1.default.Query,
        ...searchDashboard_1.searchDashboardResolver.Query,
        ...abandonedCartAnalytics_1.default.Query,
    },
};
