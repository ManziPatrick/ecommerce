 ...
 */
router.get("/", optionalAuth_1.default, productController.getAllProducts);
/**
 * @swagger
 * /products/{id}:
 *   get:
 ...
 */
router.put("/:id", protect_1.default, (0, authorizeRole_1.default)("ADMIN", "SUPERADMIN", "VENDOR"), upload_1.default.array("images", 10), productController.updateProduct);
/**
 * @swagger
 * /products:
 *   post:
 ...
 *         description: Forbidden. User does not have the required role.
 */
router.post("/", protect_1.default, (0, authorizeRole_1.default)("ADMIN", "SUPERADMIN", "VENDOR"), upload_1.default.any(), productController.createProduct);
/**
 * @swagger
 * /products/bulk:
 *   post:
 ...
 *         description: Forbidden. User does not have the required role.
 */
router.post("/bulk", protect_1.default, (0, authorizeRole_1.default)("ADMIN", "SUPERADMIN", "VENDOR"), upload_1.default.single("file"), productController.bulkCreateProducts);
/**
 * @swagger
 * /products/{id}:
 *   delete:
 ...
 *         description: Forbidden. User does not have the required role.
 */
router.delete("/:id", protect_1.default, (0, authorizeRole_1.default)("ADMIN", "SUPERADMIN", "VENDOR"), productController.deleteProduct);
