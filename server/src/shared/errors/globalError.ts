  ...
  MulterError: (err) => {
    switch (err.code) {
      case "LIMIT_FILE_SIZE":
        return new AppError(400, "File too large. Maximum size allowed is 20MB.");
      case "LIMIT_FILE_COUNT":
        return new AppError(400, "Too many files. Maximum allowed is 5.");
      case "LIMIT_UNEXPECTED_FILE":
        return new AppError(400, "Unexpected file field.");
      default:
