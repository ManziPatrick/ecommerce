    ...
    >
      ...
      <div className="space-y-6">
        {order.orderItems.map((item) => (
          ...
          >
            {/* Variant Image */}
            <div className="flex items-center justify-center mr-4 overflow-hidden shadow-sm bg-gray-100 rounded">
              <Image
                src={getCloudinaryUrl(item.variant.images?.[0] || "/placeholder-product.png")}
