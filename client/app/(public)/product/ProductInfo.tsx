  ...
  return (
    <div className="flex flex-col gap-6 px-4 sm:px-6 py-6">
      ...
      <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-600">
        ...
        <span
          className={`ml-2 px-2 py-1 rounded text-xs font-medium ${stock > 0
      ...
      <div className="flex items-baseline gap-3">
        {hasDiscount && (
          <span className="text-lg sm:text-xl text-gray-400 line-through decoration-gray-400">
            ${price.toFixed(2)}
          </span>
        )}
        ...
        {hasDiscount && (
          <span className="bg-red-100 text-red-600 px-2 py-0.5 rounded text-xs sm:text-sm font-bold uppercase tracking-tight">
                  ...
                  {valuesArray.map((value) => {
                    ...
                    return (
                      <motion.button
                        ...
                        className={`px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg font-medium text-xs sm:text-sm transition-all duration-200 ${isSelected
      ...
      <div className="space-y-3">
        <button
          ...
          className={`w-full py-3 sm:py-4 text-sm sm:text-base font-semibold text-white rounded-xl transition-all duration-300 ${isLoading || !stock || !selectedVariant
